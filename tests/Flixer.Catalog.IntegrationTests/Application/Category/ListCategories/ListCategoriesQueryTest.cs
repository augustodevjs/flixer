...
namespace Flixer.Catalog.IntegrationTests.Application.Category.ListCategories;
...
public class ListCategoriesQueryTest
{
    ...
    public ListCategoriesQueryTest(CategoryRepositoryFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    public async Task Query_SearchReturnsListAndTotal()
    {
        ...
        var logger = loggerFactory.CreateLogger<ListCategoriesQueryHandler>();
        ...
        var input = new ListCategoriesQuery(1, 20);

        var command = new ListCategoriesQueryHandler(categoryRepository, logger);
    ...
    )
    {
        ...
        var input = new ListCategoriesQuery(page, perPage);
        var categoryRepository = new CategoryRepository(dbContext);
    ...
    )
    {
        ...
        var input = new ListCategoriesQuery(page, perPage, search);
        var command = new ListCategoriesQueryHandler(categoryRepository, logger);
    ...
    )
    {
        ...
        var input = new ListCategoriesQuery(1, 20, "", orderBy, commandOrder);
        
        var useCase = new ListCategoriesQueryHandler(categoryRepository, logger);
